...
export class Runner {
  ...
  public async execute(): Promise<protos.IExecutedGraph> {
    ...
    // Set this.executionTask before waiting on any Promises to complete so that callers of resultPromise()
    // receive a real value if they call that function while schema preparation is ongoing.
