...
<div className="bp3-callout bp3-icon-info-sign bp3-intent-primary" markdown="1">
  ...
  <a href="../../how-to-guides/configuration">project configuration</a>.
</div>
...
<div className="bp3-callout bp3-icon-info-sign bp3-intent-none" markdown="1">
  ...
  <a href="../../how-to-guides/datasets">publishing datasets</a> and
  <a href="../../how-to-guides/incremental-datasets">incremental datasets</a>.
</div>
