...
Google Cloud is used as the data warehouse in this example, but [other warehouses](TODO: add reference) are viable too.
...
## 3. Give the project an inspirational name

<img src="/static/images/how_to_guides/dataform_101/3_project_name.png" style="width: 100%;" />

## 4. Choose to "create a table" from the file templates
...
Input the [project ID](TODO). For alternatives warehouses, see [here](TODO).

<img src="/static/images/how_to_guides/dataform_101/6_add_warehouse.png" style="width: 100%;" />

## 7. Select and test the server

Input [project ID](TODO: add link), [credentials](TODO: add link), and test that they are valid.
