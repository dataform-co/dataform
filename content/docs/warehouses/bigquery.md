...
[BigQuery labels](https://cloud.google.com/bigquery/docs/labels-intro) are key-value pair that helps you organize your Google Cloud BigQuery resources. To use them in Dataform, add them to the config block as so:
