...
As Dataform projects use NPM for package management, you can also control dependencies and the current dataform version through the `package.json` file. Check out the [packages guide](/guides/packages) for more information on this.
