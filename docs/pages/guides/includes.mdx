...
If you are new to Javascript, the examples below should cover most use cases. <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript" >MDN</a> is a great resource to learn more.
...
All functions and constants must be exported using the <code>module.exports = {"{}"}</code> syntax as above, on order to use them elsewhere in the project.
</div>
