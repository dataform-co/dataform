...
<a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript">MDN</a> is a useful learning resource if you'd like to learn more.
...
This function can be used in a SQL query `definitions/revenue_by_country_group.sql`:
...
This function can be used in a SQL query `definitions/example.sql`:
...
Functions can be used to generate entire queries. This is a powerful feature that can be useful if you need to create several tables which share a similar structure.
...
This function can be used in a SQL query `definitions/stats_per_country_and_device.sql`:
