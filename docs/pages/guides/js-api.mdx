...
To use the JavaScript API, create a `.js` file anywhere in the `definitions/` folder of your project. This code will be run during project compilation. Alternatively, add javascript to a `.sqlx` file by wrapping it in a `js {...}` block.
