...
Unit tests give you confidence that your code produces the output data you expect.
...
should have no dependencies on any state in your data warehouse. Thus all input datasets should be referenced using `ref()` or `resolve()`, with fake inputs
