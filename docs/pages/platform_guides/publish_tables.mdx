...
<div className="bp3-callout bp3-icon-info-sign bp3-intent-warning" markdown="1">
  Referencing a dataset that hasn't yet been created in your data warehouse will cause compilation
  errors. These compilation errors are warning you that the dataset you are referencing doesn't exist
