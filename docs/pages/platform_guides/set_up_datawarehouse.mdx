...
Dataform connects to your data warehouse on your behalf to run your project's compiled SQL.
...
2. Click `Add Service Account`, give it a name, and select the `BigQuery Admin` role. Admin access is required to create queries and list tables.
...
## Postgres (running in AWS) / Redshift
...
- Port (usually 5432 for Postgres and 5439 for Redshift)
...
The first part of your Snowflake url, including region: **account-name.region**.snowflakecomputing.com

### Account user and password

The username and password you use to log in to your Snowflake console. You may prefer to create a separate username and password for Dataform to use - please contact our team if you need help.
