...
2. Click `Add Service Account`, give it a name, and select the `BigQuery Admin` role. Admin access is required by Dataform so that it can create queries and list datasets.
