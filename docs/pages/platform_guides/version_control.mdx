...
When you first use Dataform we will automatically create a personal development branch for you, `firstname_dev`. Only you can see this branch and commit to it.
...
If you'd like to undo any changes you've made since your last commit, you can `Revert uncommited changes` from the version control menu.
