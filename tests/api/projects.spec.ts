...
suite("examples", () => {
  suite("common_v2 bigquery", ({ before }) => {
    const databaseSuffix = "foo";
    const schemaSuffix = "bar";
    ...
    let graph: dataform.CompiledGraph;
    ...
    test("can import and use an external package", () => {
    ...
    test("SQL files with raw back-ticks get escaped", () => {
    ...
    test("deferred calls to table resolve to the correct definitions file", () => {
    ...
    test('database override defined in "config {}"', () => {
    ...
    test('schema overrides defined in "config {}"', () => {
    ...
    test('schema overrides defined in "config {}" -- case with schema unchanged', () => {
    ...
    test("example operation with output", () => {
    ...
    test("double backslashes don't get converted to singular", () => {
